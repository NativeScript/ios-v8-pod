Pod::Spec.new do |s|
    s.name         = "NativeScript"
    s.version      = "0.2.1"
    s.summary      = "iOS view helpers for NativeScript"
    s.description  = "NativeScript empowers you to access native platform APIs from JavaScript directly. Angular, Capacitor, Ionic, React, Svelte, Vue and you name it compatible."
